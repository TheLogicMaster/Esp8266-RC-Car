<template>
  <q-page class="flex flex-center">
    <q-dialog v-model="rgbMenu" @before-hide="sendRGB">
      <q-card>
        ...
        <q-card-section>
          ...
          <q-color v-if="rgbType === '0'" v-model="rgb" style="max-width: 250px" />
          <div v-else>
    ...
    <q-dialog v-model="musicMenu" @before-hide="sendMusic">
      <q-card>
        <q-card-section class="row items-center">
        ...
        <q-card-section>
          <q-select filled v-model="music" :options="musicOptions" label="Music:" emit-value map-options />
          <q-toggle label="Repeat" v-model="repeatMusic" color="blue"></q-toggle>
          <div>
